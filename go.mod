...
require (
	...
	go.etcd.io/etcd v0.0.0-20240423085514-48b0c496c0ef
...
replace (
	...
	github.com/coreos/etcd => go.etcd.io/etcd v0.0.0-20240423085514-48b0c496c0ef // ae9734ed278b is the SHA for git tag v3.4.13
